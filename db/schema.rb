...
ActiveRecord::Schema.define(version: 20150703034519) do
  ...
  create_table "appointments", force: :cascade do |t|
    ...
    t.string   "email"
    t.boolean  "schedule_later"
  end

  add_index "appointments", ["department_id"], name: "index_appointments_on_department_id", using: :btree
